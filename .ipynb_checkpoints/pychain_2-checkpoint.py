...
# amount attributes. To do so, I executed the following steps:
...
# previous section. To do so, I executed the following steps:
...
# To do so, I executed the following steps:
# 1. Delete the input_data variable from the Streamlit interface.
# 2. Add an input area where you can get a value for sender from the user.
# 3. Add an input area where you can get a value for receiver from the user.
# 4. Add an input area where you can get a value for amount from the user.
# 5. As part of the Add Block button functionality, update new_block so that Block consists of an attribute named record, which is set equal to a Record that contains the sender, receiver, and amount values. The updated Blockshould also include the attributes for creator_id and prev_hash.
# @TODO:
...
################################################################################
# Step 4:
# Test the PyChain Ledger by Storing Records (see the screenahots in the README file.)